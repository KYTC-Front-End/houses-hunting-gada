...
import image from "../../Utilies/images/Register.png";
import validationRegister from '../../Utilies/validations/Register'
import "./style.css";
   ...
   const handleAddUser = async (event) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://my-json-server.typicode.com/GadaAhmed/mockread-api/users",
        {
          method: "POST",
          headers: {
